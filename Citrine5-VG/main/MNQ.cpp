...
MatrixXd MNQ::Mold()
{
    ...
    for(int i = 0; i < 50; i++)
    {
        ...
        temp(10*i + 1, 10*i + 6) = V1*ma*cos(Yold(i*10 +6)) + M*Yold(i*10 +0)*cos(Yold(i*10 +7)) + V2*ma*sin(Yold(i*10 +6)) + M*Yold(i*10 +2)*sin(Yold(i*10 +7));

        temp(10*i + 2, 10*i + 2) = M + ma;
        temp(10*i + 2, 10*i + 6) = V1*ma*sin(Yold(i*10 +6))*sin(Yold(i*10 +7)) - V2*ma*cos(Yold(i*10 +6))*sin(Yold(i*10 +7)) - M*Yold(i*10 +1)*sin(Yold(i*10 +7));
        temp(10*i + 2, 10*i + 7) = M*Yold(i*10 +0) + V3*ma*sin(Yold(i*10 +7)) - V1*ma*cos(Yold(i*10 +6))*cos(Yold(i*10 +7)) - V2*ma*cos(Yold(i*10 +7))*sin(Yold(i*10 +6));
...
MatrixXd MNQ::Mnew()
{
    ...
    for(int i = 0; i < 50; i++)
    {
        ...
        temp(10*i + 1, 10*i + 1) = M + ma;
        temp(10*i + 1, 10*i + 6) = V1*ma*cos(Ynew(i*10 +6)) + M*Ynew(i*10 +0)*cos(Ynew(i*10 +7)) + V2*ma*sin(Ynew(i*10 +6)) + M*Ynew(i*10 +2)*sin(Ynew(i*10 +7));

        temp(10*i + 2, 10*i + 2) = M + ma;
        temp(10*i + 2, 10*i + 6) = V1*ma*sin(Ynew(i*10 +6))*sin(Ynew(i*10 +7)) - V2*ma*cos(Ynew(i*10 +6))*sin(Ynew(i*10 +7)) - M*Ynew(i*10 +1)*sin(Ynew(i*10 +7));
        temp(10*i + 2, 10*i + 7) = M*Ynew(i*10 +0) + V3*ma*sin(Ynew(i*10 +7)) - V1*ma*cos(Ynew(i*10 +6))*cos(Ynew(i*10 +7)) - V2*ma*cos(Ynew(i*10 +7))*sin(Ynew(i*10 +6));
...
{  
    ...
    for(int i = 0; i < 50; i++)
    {
        ...
        temp(i*10 + 1) = 0.5*Cdn*d0*rho*sqrt(Yold(i*10 +3)/(A*E) + 1)*sqrt(pow((Yold(i*10 +1) - V2*cos(Yold(i*10 +6)) + V1*sin(Yold(i*10 +6))),2) + pow((V3*cos(Yold(i*10 +7)) - Yold(i*10 +2) + V1*cos(Yold(i*10 +6))*sin(Yold(i*10 +7)) + V2*sin(Yold(i*10 +6))*sin(Yold(i*10 +7))),2))*(Yold(i*10 +1) - V2*cos(Yold(i*10 +6)) + V1*sin(Yold(i*10 +6))) - w0*sin(Yold(i*10 +6)) - Yold(i*10 +9)*Yold(i*10 +5)*tan(Yold(i*10 +7)) - Yold(i*10 +9)*Yold(i*10 +3);
        temp(i*10 + 2) = Yold(i*10 +8)*Yold(i*10 +3) - w0*cos(Yold(i*10 +6))*sin(Yold(i*10 +7)) + Yold(i*10 +9)*Yold(i*10 +4)*tan(Yold(i*10 +7)) - 0.5*Cdb*d0*rho*sqrt(Yold(i*10 +3)/(A*E) + 1)*sqrt(pow((Yold(i*10 +1) - V2*cos(Yold(i*10 +6)) + V1*sin(Yold(i*10 +6))),2) + pow((V3*cos(Yold(i*10 +7)) - Yold(i*10 +2) + V1*cos(Yold(i*10 +6))*sin(Yold(i*10 +7)) + V2*sin(Yold(i*10 +6))*sin(Yold(i*10 +7))),2))*(V3*cos(Yold(i*10 +7)) - Yold(i*10 +2) + V1*cos(Yold(i*10 +6))*sin(Yold(i*10 +7)) + V2*sin(Yold(i*10 +6))*sin(Yold(i*10 +7)));
