...
VectorXd Fx::fx()
{
    ...
    BCtemp0(0) = Y0new(0) - (Vtx*cos(Y0new(7))*cos(Y0new(6)) + Vty*cos(Y0new(6))*sin(Y0new(7))- Vtz*sin(Y0new(6)));
    BCtemp0(1) = Y0new(1) - (Vty*cos(Y0new(7)) - Vtx*sin(Y0new(7)));
    BCtemp0(2) = Y0new(2) - (Vtx*cos(Y0new(7))*sin(Y0new(6)) + Vty*sin(Y0new(6))*sin(Y0new(7)) + Vtz*cos(Y0new(6)));
    BCtemp0(3) = Y0new(8);
    BCtemp0(4) = Y0new(9);

    BCtemp1(0) = Y49new(3) - (Gbx*cos(Y49new(7))*cos(Y49new(6)) + Gby*cos(Y49new(6))*sin(Y49new(7))- Gbz*sin(Y49new(6)));
    BCtemp1(1) = Y49new(4) - (Gby*cos(Y49new(7)) - Gbx*sin(Y49new(7)));
    BCtemp1(2) = Y49new(5) - (Gbx*cos(Y49new(7))*sin(Y49new(6)) + Gby*sin(Y49new(6))*sin(Y49new(7)) + Gbz*cos(Y49new(6)));
    BCtemp1(3) = Y49new(8);
    BCtemp1(4) = Y49new(9);
