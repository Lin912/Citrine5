...
MatrixXd Jacobian::jacobian()
{
    ...
    temp(495, 494) = 0;
    temp(495, 495) = 0;
    temp(495, 496) = Vbz*cos(Ynew(496)) + Vbx*cos(Ynew(497))*sin(Ynew(496)) + Vby*sin(Ynew(497))*sin(Ynew(496)); 
    temp(495, 497) = Vbx*cos(Ynew(496))*sin(Ynew(497)) - Vby*cos(Ynew(497))*cos(Ynew(496));
    temp(495, 498) = 0;
    temp(495, 499) = 0;
    ...
    temp(496, 495) = 0;
    temp(496, 496) = 0;
    temp(496, 497) = Vbx*cos(Ynew(497)) + Vby*sin(Ynew(497));
    temp(496, 498) = 0;
    temp(496, 499) = 0;
    ...
    temp(497, 494) = 0;
    temp(497, 495) = 0;
    temp(497, 496) = Vbz*sin(Ynew(496)) - Vbx*cos(Ynew(497))*cos(Ynew(496)) - Vby*cos(Ynew(496))*sin(Ynew(497));
    temp(497, 497) = Vbx*sin(Ynew(497))*sin(Ynew(496)) - Vby*cos(Ynew(497))*sin(Ynew(496));
    temp(497, 498) = 0;
    temp(497, 499) = 0;
