...
MatrixXd Jacobian::jacobian()
{
    ...
    temp(0, 4) = 0;
    temp(0, 5) = 0;
    temp(0, 6) = Vtz*cos(Ynew(7))*sin(Ynew(6)) - Vty*cos(Ynew(7))*cos(Ynew(6));   
    temp(0, 7) = Vtx*cos(Ynew(7)) + Vtz*cos(Ynew(6))*sin(Ynew(7)) + Vty*sin(Ynew(7))*sin(Ynew(6));
    temp(0, 8) = 0;
    temp(0, 9) = 0;
    ...
    temp(1, 4) = 0;
    temp(1, 5) = 0;
    temp(1, 6) = Vtz*sin(Ynew(7))*sin(Ynew(6)) - Vty*cos(Ynew(6))*sin(Ynew(7));
    temp(1, 7) = Vtx*sin(Ynew(7)) - Vtz*cos(Ynew(7))*cos(Ynew(6)) - Vty*cos(Ynew(7))*sin(Ynew(6));
    temp(1, 8) = 0;
    temp(1, 9) = 0;
    ...
    temp(2, 4) = 0;
    temp(2, 5) = 0;
    temp(2, 6) = Vtz*cos(Ynew(6)) + Vty*sin(Ynew(6));
    temp(2, 7) = 0;
    temp(2, 8) = 0;
    temp(2, 9) = 0;
    ...
    temp(495, 494) = 0;
    temp(495, 495) = 0;
    temp(495, 496) = Gz*cos(Ynew(497))*sin(Ynew(496)) - Gy*cos(Ynew(497))*cos(Ynew(496));  
    temp(495, 497) = Gx*cos(Ynew(497)) + Gz*cos(Ynew(496))*sin(Ynew(497)) + Gy*sin(Ynew(497))*sin(Ynew(496));
    temp(495, 498) = 0;
    temp(495, 499) = 0;
    ...
    temp(496, 494) = 1;
    temp(496, 495) = 0;
    temp(496, 496) = Gz*sin(Ynew(497))*sin(Ynew(496)) - Gy*cos(Ynew(496))*sin(Ynew(497));
    temp(496, 497) = Gx*sin(Ynew(497)) - Gz*cos(Ynew(497))*cos(Ynew(496)) - Gy*cos(Ynew(497))*sin(Ynew(496));
    temp(496, 498) = 0;
    temp(496, 499) = 0;
    ...
    temp(497, 494) = 0;
    temp(497, 495) = 1;
    temp(497, 496) = Gz*cos(Ynew(496)) + Gy*sin(Ynew(496));
    temp(497, 497) = 0;
    temp(497, 498) = 0;
    temp(497, 499) = 0;
...
//Block01    
    for(int i = 0; i < 49; i++)
    {
        ...
        temp(i*10 + 5, i*10 + 3) = 2*deltaT - (0.25*Cdt*d0*deltaS*deltaT*pi*rho*abs(Ynew(i*10+ 0) + Vx*sin(Ynew(i*10+ 6)) - Vz*cos(Ynew(i*10+ 7))*cos(Ynew(i*10+ 6)) - Vy*cos(Ynew(i*10+ 7))*sin(Ynew(i*10+ 6)))*(Ynew(i*10+ 0) + Vx*sin(Ynew(i*10+ 6)) - Vz*cos(Ynew(i*10+ 7))*cos(Ynew(i*10+ 6)) - Vy*cos(Ynew(i*10+ 7))*sin(Ynew(i*10+ 6))))/(A*E*sqrt(Ynew(i*10+ 3)/(A*E) + 1));
        ...
        temp(i*10 + 6, i*10 + 7) = deltaS*((Yold(i*10+ 7) - Ynew(i*10+ 7))*(Vz*ma*cos(Ynew(i*10+ 6))*sin(Ynew(i*10+ 7)) + Vy*ma*sin(Ynew(i*10+ 7))*sin(Ynew(i*10+ 6))) - (Yold(i*10+ 6) - Ynew(i*10+ 6))*(Vy*ma*cos(Ynew(i*10+ 7))*cos(Ynew(i*10+ 6)) - Vz*ma*cos(Ynew(i*10+ 7))*sin(Ynew(i*10+ 6))) + M*Ynew(i*10+ 0)*cos(Ynew(i*10+ 6)) + M*Yold(i*10+ 0 )*cos(Yold(i*10+ 6)) + M*Ynew(i*10+ 2)*sin(Ynew(i*10+ 6)) + M*Yold(i*10+ 2)*sin(Yold(i*10+ 6)) + Vz*ma*cos(Yold(i*10+ 7))*cos(Yold(i*10+ 6)) + Vz*ma*cos(Ynew(i*10+ 7))*cos(Ynew(i*10+ 6)) + Vy*ma*cos(Yold(i*10+ 7))*sin(Yold(i*10+ 6)) + Vy*ma*cos(Ynew(i*10+ 7))*sin(Ynew(i*10+ 6))) + deltaS*deltaT*(w0*sin(Ynew(i*10+ 7)) + 0.5*Cdn*rho*sqrt(Ynew(i*10+ 3)/(A*E) + 1)*(Vz*cos(Ynew(i*10+ 7))*cos(Ynew(i*10+ 6)) + Vy*cos(Ynew(i*10+ 7))*sin(Ynew(i*10+ 6)))*sqrt(pow((Ynew(i*10+ 2) - Vy*cos(Ynew(i*10+ 6)) + Vz*sin(Ynew(i*10+ 6))),2) + pow((Vx*cos(Ynew(i*10+ 6)) - Ynew(i*10+ 1) + Vz*cos(Ynew(i*10+ 6))*sin(Ynew(i*10+ 7)) + Vy*sin(Ynew(i*10+ 7))*sin(Ynew(i*10+ 6))),2)) + (0.5*Cdn*rho*sqrt(Ynew(i*10+ 3)/(A*E) + 1)*(Vz*cos(Ynew(i*10+ 7))*cos(Ynew(i*10+ 6)) + Vy*cos(Ynew(i*10+ 7))*sin(Ynew(i*10+ 6)))*pow((Vx*cos(Ynew(i*10+ 6)) - Ynew(i*10+ 1) + Vz*cos(Ynew(i*10+ 6))*sin(Ynew(i*10+ 7)) + Vy*sin(Ynew(i*10+ 7))*sin(Ynew(i*10+ 6))),2))/sqrt(pow((Ynew(i*10+ 2) - Vy*cos(Ynew(i*10+ 6)) + Vz*sin(Ynew(i*10+ 6))),2) + pow((Vx*cos(Ynew(i*10+ 6)) - Ynew(i*10+ 1) + Vz*cos(Ynew(i*10+ 6))*sin(Ynew(i*10+ 7)) + Vy*sin(Ynew(i*10+ 7))*sin(Ynew(i*10+ 6))),2)));
    ...
    for(int i = 0; i < 49; i++)
    {
        ...
        temp(i*10 + 6, i*10 + 17) = deltaS*((Yold(i*10+ 17) - Ynew(i*10+ 17))*(Vz*ma*cos(Ynew(i*10+ 16))*sin(Ynew(i*10+ 17)) + Vy*ma*sin(Ynew(i*10+ 17))*sin(Ynew(i*10+ 16))) - (Yold(i*10+ 16) - Ynew(i*10+ 16))*(Vy*ma*cos(Ynew(i*10+ 17))*cos(Ynew(i*10+ 16)) - Vz*ma*cos(Ynew(i*10+ 17))*sin(Ynew(i*10+ 16))) + M*Ynew(i*10+ 10)*cos(Ynew(i*10+ 16)) + M*Yold(i*10+ 10)*cos(Yold(i*10+ 16)) + M*Ynew(i*10+ 12)*sin(Ynew(i*10+ 16)) + M*Yold(i*10+ 12)*sin(Yold(i*10+ 16)) + Vz*ma*cos(Yold(i*10+ 17))*cos(Yold(i*10+ 16)) + Vz*ma*cos(Ynew(i*10+ 17))*cos(Ynew(i*10+ 16)) + Vy*ma*cos(Yold(i*10+ 17))*sin(Yold(i*10+ 16)) + Vy*ma*cos(Ynew(i*10+ 17))*sin(Ynew(i*10+ 16))) + deltaS*deltaT*(w0*sin(Ynew(i*10+ 17)) + 0.5*Cdn*rho*sqrt(Ynew(i*10+ 13)/(A*E) + 1)*(Vz*cos(Ynew(i*10+ 17))*cos(Ynew(i*10+ 16)) + Vy*cos(Ynew(i*10+ 17))*sin(Ynew(i*10+ 16)))*sqrt(pow((Ynew(i*10+ 12) - Vy*cos(Ynew(i*10+ 16)) + Vz*sin(Ynew(i*10+ 16))),2) + pow((Vx*cos(Ynew(i*10+ 16)) - Ynew(i*10+ 11) + Vz*cos(Ynew(i*10+ 16))*sin(Ynew(i*10+ 17)) + Vy*sin(Ynew(i*10+ 17))*sin(Ynew(i*10+ 16))),2)) + (0.5*Cdn*rho*sqrt(Ynew(i*10+ 13)/(A*E) + 1)*(Vz*cos(Ynew(i*10+ 17))*cos(Ynew(i*10+ 16)) + Vy*cos(Ynew(i*10+ 17))*sin(Ynew(i*10+ 16)))*pow((Vx*cos(Ynew(i*10+ 16)) - Ynew(i*10+ 11) + Vz*cos(Ynew(i*10+ 16))*sin(Ynew(i*10+ 17)) + Vy*sin(Ynew(i*10+ 17))*sin(Ynew(i*10+ 16))),2))/sqrt(pow((Ynew(i*10+ 12) - Vy*cos(Ynew(i*10+ 16)) + Vz*sin(Ynew(i*10+ 16))),2) + pow((Vx*cos(Ynew(i*10+ 16)) - Ynew(i*10+ 11) + Vz*cos(Ynew(i*10+ 16))*sin(Ynew(i*10+ 17)) + Vy*sin(Ynew(i*10+ 17))*sin(Ynew(i*10+ 16))),2)));
