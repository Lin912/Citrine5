...
MatrixXd MNQ::Mold()
{
    ...
    for(int i = 0; i < 50; i++)
    {
        ...
        temp(10*i + 1, 10*i + 6) = Vy*ma*cos(Yold(i*10 + 6))*sin(Yold(i*10 + 7)) - Vx*ma*sin(Yold(i*10 + 6)) - Vz*ma*sin(Yold(i*10 + 7))*sin(Yold(i*10 + 6));
        temp(10*i + 1, 10*i + 7) = M*Yold(i*10 + 0)*cos(Yold(i*10 + 6)) + M*Yold(i*10 + 2)*sin(Yold(i*10 + 6)) + Vz*ma*cos(Yold(i*10 + 7))*cos(Yold(i*10 + 6)) + Vy*ma*cos(Yold(i*10 + 7))*sin(Yold(i*10 + 6));

        temp(10*i + 2, 10*i + 2) = M - ma;
        temp(10*i + 2, 10*i + 6) = - M*Yold(i*10 + 0) - Vz*ma*cos(Yold(i*10 + 6)) - Vy*ma*sin(Yold(i*10 + 6));
        temp(10*i + 2, 10*i + 7) = -M*Yold(i*10 + 1)*sin(Yold(i*10 + 6));
...
MatrixXd MNQ::Mnew()
{
    ...
    for(int i = 0; i < 50; i++)
    {
        ...
        temp(10*i + 1, 10*i + 1) = M - ma;
        temp(10*i + 1, 10*i + 6) = Vy*ma*cos(Ynew(i*10 + 6))*sin(Ynew(i*10 + 7)) - Vx*ma*sin(Ynew(i*10 + 6)) - Vz*ma*sin(Ynew(i*10 + 7))*sin(Ynew(i*10 + 6));
        temp(10*i + 1, 10*i + 7) = M*Ynew(i*10 + 0)*cos(Ynew(i*10 + 6)) + M*Ynew(i*10 + 2)*sin(Ynew(i*10 + 6)) + Vz*ma*cos(Ynew(i*10 + 7))*cos(Ynew(i*10 + 6)) + Vy*ma*cos(Ynew(i*10 + 7))*sin(Ynew(i*10 + 6));

        temp(10*i + 2, 10*i + 2) = M - ma;
        temp(10*i + 2, 10*i + 6) = - M*Ynew(i*10 + 0) - Vz*ma*cos(Ynew(i*10 + 6)) - Vy*ma*sin(Ynew(i*10 + 6));
        temp(10*i + 2, 10*i + 7) = -M*Ynew(i*10 + 1)*sin(Ynew(i*10 + 6));
...
{  
    ...
    for(int i = 0; i < 50; i++)
    {
        ...
        temp(i*10 + 1) = 0.5*Cdn*rho*sqrt(Yold(i*10 +3)/(A*E) + 1)*sqrt(pow((Yold(i*10 +2) - Vy*cos(Yold(i*10 +6)) + Vz*sin(Yold(i*10 +6))),2) + pow((Vx*cos(Yold(i*10 +6)) - Yold(i*10 +1) + Vz*cos(Yold(i*10 +6))*sin(Yold(i*10 +7)) + Vy*sin(Yold(i*10 +7))*sin(Yold(i*10 +6))),2))*(Vx*cos(Yold(i*10 +6)) - Yold(i*10 +1) + Vz*cos(Yold(i*10 +6))*sin(Yold(i*10 +7)) + Vy*sin(Yold(i*10 +7))*sin(Yold(i*10 +6))) - w0*cos(Yold(i*10 +7)) - Yold(i*10 +9)*Yold(i*10 +5)*tan(Yold(i*10 +6)) - Yold(i*10 +9)*Yold(i*10 +3);
