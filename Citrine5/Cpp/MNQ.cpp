...
{  
    ...
    for(int i = 0; i < 50; i++)
    {
        temp(i*10 + 0) = Yold(i*10 +9)*Yold(i*10 +4) - Yold(i*10 +8)*Yold(i*10 +5) - M*g*cos(Yold(i*10 +7))*cos(Yold(i*10 +6)) - 0.5*Cdt*pi*rho*abs(Yold(i*10 +0) + V3*sin(Yold(i*10 +6)) - V1*cos(Yold(i*10 +7))*cos(Yold(i*10 +6)) + V2*cos(Yold(i*10 +6))*sin(Yold(i*10 +7)))*sqrt(Yold(i*10 +3)/(A*E) + 1)*(Yold(i*10 +0) + V3*sin(Yold(i*10 +6)) - V1*cos(Yold(i*10 +7))*cos(Yold(i*10 +6)) + V2*cos(Yold(i*10 +6))*sin(Yold(i*10 +7)));
        ...
        temp(i*10 + 4) = Yold(i*10 +4)*pow((Yold(i*10 +3)/(A*E) + 1),3) - E*I*Yold(i*10 +8)*Yold(i*10 +9)*tan(Yold(i*10 +6));
...
VectorXd MNQ::Qnew()
{
   ...
   for(int i = 0; i < 50; i++)
    {
        temp(i*10 + 0) = Ynew(i*10 +9)*Ynew(i*10 +4) - Ynew(i*10 +8)*Ynew(i*10 +5) - M*g*cos(Ynew(i*10 +7))*cos(Ynew(i*10 +6)) - 0.5*Cdt*pi*rho*abs(Ynew(i*10 +0) + V3*sin(Ynew(i*10 +6)) - V1*cos(Ynew(i*10 +7))*cos(Ynew(i*10 +6)) + V2*cos(Ynew(i*10 +6))*sin(Ynew(i*10 +7)))*sqrt(Ynew(i*10 +3)/(A*E) + 1)*(Ynew(i*10 +0) + V3*sin(Ynew(i*10 +6)) - V1*cos(Ynew(i*10 +7))*cos(Ynew(i*10 +6)) + V2*cos(Ynew(i*10 +6))*sin(Ynew(i*10 +7)));
        ...
        temp(i*10 + 4) = Ynew(i*10 +4)*pow((Ynew(i*10 +3)/(A*E) + 1),3) - E*I*Ynew(i*10 +8)*Ynew(i*10 +9)*tan(Ynew(i*10 +6));
