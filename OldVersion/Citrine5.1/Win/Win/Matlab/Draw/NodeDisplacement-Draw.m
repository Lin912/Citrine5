...
title("Displacement Point1 X-Direction",'fontsize',16,'fontname','times new roman');
...
subplot(2,3,4);
plot(t,Y50,"-",'LineWidth',1.5);
xlim([0 10]);
ylim([-0.5 0.5]);
set(gca,'XTick',0:1:10);
set(gca,'YTick',-0.5:0.1:0.5);
title("Displacement Point50 X-Direction",'fontsize',16,'fontname','times new roman');
xlabel("Time(s)",'fontname','times new roman');
ylabel("Displacement(m)",'fontname','times new roman');
grid on;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
set(gca,'XTick',0:1:10);
set(gca,'YTick',-0.5:0.1:0.5);
title("Displacement Point1 Y-Direction",'fontsize',16,'fontname','times new roman');
xlabel("Time(s)",'fontname','times new roman');
ylabel("Displacement(m)",'fontname','times new roman');
grid on;
hold on;
...
subplot(2,3,5);
plot(t,X50,"-",'LineWidth',1.5);
xlim([0 10]);
ylim([-0.5 0.5]);
set(gca,'XTick',0:1:10);
set(gca,'YTick',-0.5:0.1:0.5);
title("Displacement Point50 Y-Direction",'fontsize',16,'fontname','times new roman');
xlabel("Time(s)",'fontname','times new roman');
ylabel("Displacement(m)",'fontname','times new roman');
grid on;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
set(gca,'XTick',0:1:10);
set(gca,'YTick',-0.5:0.1:0.5);
title("Displacement Point1 Z-Direction",'fontsize',16,'fontname','times new roman');
xlabel("Time(s)",'fontname','times new roman');
ylabel("Displacement(m)",'fontname','times new roman');
grid on;
hold on;
...
subplot(2,3,6);
plot(t,Z50,"-",'LineWidth',1.5);
xlim([0 10]);
ylim([-0.5 0.5]);
set(gca,'XTick',0:1:10);
set(gca,'YTick',-0.5:0.1:0.5);
title("Displacement Point50 Z-Direction",'fontsize',16,'fontname','times new roman');
xlabel("Time(s)",'fontname','times new roman');
ylabel("Displacement(m)",'fontname','times new roman');
grid on;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
